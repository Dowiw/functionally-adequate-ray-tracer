...
int	test_translation(void)
{
	...
	transform = m4x4_translation(5.0, -3.0, 2.0);
	point = (t_tuple){-3.0, 4.0, 5.0, POINT};
	expected = (t_tuple){2.0, 1.0, 7.0, POINT};

	result = m4x4_multiply_tuple(transform, point);
	...
	transform = m4x4_translation(5.0, -3.0, 2.0);
	inverse = m4x4_inverse(transform);
	point = (t_tuple){-3.0, 4.0, 5.0, POINT};
	expected = (t_tuple){-8.0, 7.0, 3.0, POINT};

	result = m4x4_multiply_tuple(inverse, point);
	...
	result = m4x4_multiply_tuple(transform, vector);
...
int	test_scaling(void)
{
	...
	transform = m4x4_scaling(2.0, 3.0, 4.0);
	...
	result = m4x4_multiply_tuple(inverse, vector);

	UNIT_ASSERT_EQ(compare_tuples(&expected, &result), 0);

	transform = m4x4_scaling(-1.0, 1.0, 1.0);
...
int	test_rotation(void)
{
	...
	transform = m4x4_rotation_x(PI / 4.0);
	...
	transform = m4x4_rotation_x(PI / 2.0);
	point = (t_tuple){0.0, 1.0, 0.0, POINT};
	...
	transform = m4x4_inverse(m4x4_rotation_x(PI / 4.0));
	point = (t_tuple){0.0, 1.0, 0.0, POINT};
	expected = (t_tuple){0.0, sqrt(2.0) / 2.0, -sqrt(2.0) / 2.0, POINT};
	...
	transform = m4x4_rotation_y(PI / 4.0);
	...
	transform = m4x4_rotation_y(PI / 2.0);
	point = (t_tuple){0.0, 0.0, 1.0, POINT};
	...
	transform = m4x4_rotation_z(PI / 4.0);
	point = (t_tuple){0.0, 1.0, 0.0, POINT};
	...
	transform = m4x4_rotation_z(PI / 2.0);
	point = (t_tuple){0.0, 1.0, 0.0, POINT};
	expected = (t_tuple){-1.0, 0.0, 0.0, POINT};
...
int	test_chaining(void)
{
	...
	rotation = m4x4_rotation_x(PI / 2.0);
	scaling = m4x4_scaling(5.0, 5.0, 5.0);
	translation = m4x4_translation(10.0, 5.0, 7.0);

	point = (t_tuple){1.0, 0.0, 1.0, POINT};
	expected = (t_tuple){1.0, -1.0, 0.0, POINT};

	result = m4x4_multiply_tuple(rotation, point);

	UNIT_ASSERT_EQ(compare_tuples(&expected, &result), 0);

	expected = (t_tuple){5.0, -5.0, 0.0, POINT};

	result = m4x4_multiply_tuple(scaling, result);

	UNIT_ASSERT_EQ(compare_tuples(&expected, &result), 0);

	expected = (t_tuple){15.0, 0.0, 7.0, POINT};

	result = m4x4_multiply_tuple(translation, result);
	...
	result = m4x4_multiply_tuple(translation, m4x4_multiply_tuple(scaling, m4x4_multiply_tuple(rotation, point)));
